...
//                var streamEvents = _eventRepository.ListAsync(spec, cancellationToken)
//                    .Result
//                    .Where(EventArgs => EventArgs.Version > anemicModel.Version)
//                    .OrderBy(e => e.AggregateVersion)
//                    .ToListReadUncommittedAsync();
...
//                    $"Aggregate {defaultStreamId} streamed {streamEvents.Count} events at {sw.ElapsedMilliseconds} ms.");
...
//            try
//            {
//                var root = ev.ChangedValueObjects.TryGetValue(nameof(IChatAnemicModel.Root), out var rawRoot)
//                           && rawRoot is ChatRoot rootValueObject
//                    ? rootValueObject
//                    : model.Root;

//                var actor = ev.ChangedValueObjects.TryGetValue(nameof(IChatAnemicModel.Actor), out var rawActor)
//                           && rawActor is ChatActor actorValueObject
//                    ? actorValueObject
//                    : model.Actor;

//                var feedback = ev.ChangedValueObjects.TryGetValue(nameof(IChatAnemicModel.Feedback), out var rawFeedback)
